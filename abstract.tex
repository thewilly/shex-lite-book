...
object-oriented programming languages have, is proved and shown to be
possible to implement a system that automatically translates up to 50\% of the
existing shapes from GitHub to object oriented languages.
