...
\begin{document}
	...
	\input{chapters/current-analyzers-analysis.tex}
	\input{chapters/proposed-analyzer.tex}

	\part{Translating ShEx Schemas to Object Domain Models}
	\input{chapters/odm-translate.tex}
	\input{chapters/proposed-system.tex}

	\part{Project Sinthesis}
	\input{chapters/evauation-of-results.tex}
	\input{chapters/planning-and-budget.tex}
	...
	\begin{appendices}
		...
		\input{appendices/project-comunications.tex}
	\end{appendices}
